...
try {
    ...
    const queryText = 'INSERT INTO users (name, email, phone_number, password) VALUES ($1, $2, $3, $4) RETURNING *';
    const values = [createdUser.name, createdUser.email, createdUser.phone, createdUser.password];
